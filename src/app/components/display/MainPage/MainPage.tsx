            ...
            <section className={styles.main_block}>
                <div className="container">
                    <div className={styles.block_info}>
                        ...
                        <Link href="/log-in">Get started <IoIosArrowForward /></Link>
                    ...
                    <div className={styles.grid_blocks}>
                        ...
                        <div className={styles.grid_grid}> 
                            ...
                            <div className={styles.grid_block}>
                                  ...
                                  <img src="./grid/one.png" alt="decore" />
                            </div>
                            ...
                            <div className={styles.grid_block}>
                                  ...
                                  <div className={styles.grid_text}>
                                    ...
                                    <p>Discover KeplerPlanner: Plan, Organize, Succeed. Register for Efficient Time Management Today!</p>
                                 </div>

                                 <img src="./grid/two.png" alt="decore" />
                            </div>
                            ...
                            <div className={styles.grid_block}>
                                ...
                                <div className={styles.grid_text}>
                                    ...
                                    <p>With KeplerPlanner, creating, tracking, and completing tasks becomes easy and swift. 
                                    Free up time for what matters most by letting our application take care of the details.</p>
                                </div>

                                <img src="./grid/three.png" alt="decore" />
                            </div>
                            ...
                            <div className={styles.grid_block}>
                                  ...
                                  <img src="./grid/four.png" alt="decore" />
                            </div>
